defmodule KonewWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: KonewWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KonewWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KonewWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  # Helpers for showing/hiding the modal (used in phx-mounted)
